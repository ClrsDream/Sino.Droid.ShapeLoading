...
namespace Sino.Droid.ShapeLoading
{
    public class ShapeLoadingView : View
    {
        ...
        {
            mPaint = new Paint();
            mPaint.Color = Resources.GetColor(Resource.Color.sino_shapeloading_triangle);
            mPaint.AntiAlias = true;
            mPaint.SetStyle(Paint.Style.FillAndStroke);
            SetBackgroundColor(Resources.GetColor(Resource.Color.sino_shapeloading_view_bg));
        }
                ...
                case Shape.CIRCLE:
                    {
                        ...
                        {
                            mPaint.Color = Resources.GetColor(Resource.Color.sino_shapeloading_circle);
                            Path path = new Path();
                ...
                case Shape.RECT:
                    {
                        ...
                        {
                            mPaint.Color = Resources.GetColor(Resource.Color.sino_shapeloading_rect);
